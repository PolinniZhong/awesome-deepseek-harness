...
- [PolinniZhong/dsh-omi-voice](https://github.com/PolinniZhong/dsh-omi-voice) — Read AI replies aloud in DeepSeek Harness (Doubao TTS, BYOK): tap 🔊 to read/pause/resume, only the final answer, filters code/tables/diagrams. Includes the local Omi engine (Swift). MIT.
